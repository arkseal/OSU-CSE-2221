...
public final class AppendUndoView1 extends JFrame implements AppendUndoView {
     ...
     */
    private static final int LINES_IN_TEXT_AREAS = 5, LINE_LENGTHS_IN_TEXT_AREAS = 20,
            ROWS_IN_BUTTON_PANEL_GRID = 1, COLUMNS_IN_BUTTON_PANEL_GRID = 3,
            ROWS_IN_THIS_GRID = 3, COLUMNS_IN_THIS_GRID = 1;
    ...
    public AppendUndoView1() {
         ...
         */
        super("Simple GUI AppendUndo With MVC");
        ...
        JPanel buttonPanel = new JPanel(
                new GridLayout(ROWS_IN_BUTTON_PANEL_GRID, COLUMNS_IN_BUTTON_PANEL_GRID));
        /*
    ...
    public void actionPerformed(ActionEvent event) {
         ...
         * to refresh the view
         */
        this.updateUndoAllowed(!this.outputText.getText().isEmpty());
        ...
        } else if (source == this.undoButton && this.undoAllowed) {
